...
if not exists(USR_PATH):
	try:
		...
		print("Errore durante la creazione della directory: %s", e)
...
class ForecaPreview(Screen, HelpableScreen):
	...
	def __init__(self, session):
		...
		# fav2 = load_fav_location("/fav2.cfg", "Moskva")
		# print(pluginPrintname, "fav2 location:", fav2)

		# start = load_home_location("/startservice.cfg", "United_Kingdom/London")
		...
		if exists(USR_PATH + "/fav2.cfg"):
			...
			fav2 = fav2[fav2.rfind("/") + 1:]  # Estrai solo la parte finale del percorso
		else:
			fav2 = "Moskva"
		print(pluginPrintname, "fav2 location:", fav2)
